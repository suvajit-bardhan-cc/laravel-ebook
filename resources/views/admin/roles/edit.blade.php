    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Update role details and permissions</p>
            </div>
                ...
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description"
                                  ...
                                  class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description', $role->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
