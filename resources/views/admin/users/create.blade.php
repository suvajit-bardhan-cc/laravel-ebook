            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6" id="createUserForm">
                ...
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="role_id"
                                id="role_id"
                                class="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('role_id') border-red-500 @enderror">
                        ...
                        @error('role_id')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Assign a role to this user to set their permissions</p>
                    </div>
